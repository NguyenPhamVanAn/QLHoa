...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="dstheloai" runat="server" ConnectionString="<%$ ConnectionStrings:pc0302\SQLEXPRESS %>" SelectCommand="SELECT * FROM [Loai]">
</asp:SqlDataSource>
    <asp:SqlDataSource ID="dshoa" runat="server" ConnectionString="<%$ ConnectionStrings:pc0302\SQLEXPRESS %>" SelectCommand="SELECT * FROM [Hoa] WHERE ([MaLoai] = @MaLoai)">
        <SelectParameters>
